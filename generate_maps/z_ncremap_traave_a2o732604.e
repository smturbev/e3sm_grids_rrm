...
++ '[' -n '' ']'
++ PATH=/projects/netpub/anaconda3/2022.05/bin:/projects/aue/hpc/builds/x86_64/rhel8/f6a36cb8/tooling-sprint-24.02/install/linux-rhel8-x86_64/gcc-10.3.0/python-3.11.6-qvlrkva/bin:/home/smturbe/.vscode-server/cli/servers/Stable-618725e67565b290ba4da6fe2d29f8fa1d4e3622/server/bin/remote-cli:/projects/netpub/anaconda3/2022.05/bin:/projects/netpub/anaconda3/2022.05/condabin:/usr/lpp/mmfs/bin:/opt/ibm/MCStore/bin:/opt/ibm/MCStore/scripts:/usr/lib64/ccache:/usr/local/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/ascldap/users/smturbe/.vscode-server/extensions/ms-python.debugpy-2025.16.0/bundled/scripts/noConfigScripts
++ export PATH
...
+ map1=map_oQU480_to_ne4np4_traave.251216.nc
map2="map_${ocn_name}_to_${atm_name}_tribilin.${datestring}.nc"
+ map2=map_oQU480_to_ne4np4_tribilin.251216.nc
map3="map_${ocn_name}_to_${atm_name}_trfv2.${datestring}.nc"
+ map3=map_oQU480_to_ne4np4_trfv2.251216.nc
map4="map_${ocn_name}_to_${atm_name}_trintbilin.${datestring}.nc"
+ map4=map_oQU480_to_ne4np4_trintbilin.251216.nc
map5="map_${atm_name}_to_${ocn_name}_traave.${datestring}.nc"
+ map5=map_ne4np4_to_oQU480_traave.251216.nc
map6="map_${atm_name}_to_${ocn_name}_tribilin.${datestring}.nc"
+ map6=map_ne4np4_to_oQU480_tribilin.251216.nc
map7="map_${atm_name}_to_${ocn_name}_trfv2.${datestring}.nc"
+ map7=map_ne4np4_to_oQU480_trfv2.251216.nc
map8="map_${atm_name}_to_${ocn_name}_trintbilin.${datestring}.nc"
+ map8=map_ne4np4_to_oQU480_trintbilin.251216.nc

ncremap --alg_typ=traave           --grd_src="${ocn_grid_file}" --grd_dst="${atm_grid_file}" --map_fl="${map1}"
+ ncremap --alg_typ=traave --grd_src=/projects/ccsm/inputdata/ocn/mpas-o/oQU480/ocean.QU.480km.151209.nc --grd_dst=/tscratch/smturbe/e3sm_grids/ne4/ne4pg2.g --map_fl=map_oQU480_to_ne4np4_traave.251216.nc
/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/bin/ncremap: line 469: 135844 Segmentation fault      tput setaf 1 &> /dev/null
