...
+ ocn_grid_file=/projects/ccsm/inputdata/share/meshes/mpas/ocean/ocean.QU.480km.scrip.181106.nc
...
+ ncremap --a2o --alg_typ=traave --grd_src=/tscratch/smturbe/e3sm_grids/ne4/ne4pg2.g --grd_dst=/projects/ccsm/inputdata/share/meshes/mpas/ocean/ocean.QU.480km.scrip.181106.nc --map_fl=map_ne4np4_to_oQU480_traave.251218.nc
/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/bin/ncremap: line 469: 182067 Segmentation fault      tput setaf 1 &> /dev/null
...
# map_opts='--in_type fv --in_np 1 --out_type fv --out_np 1 --out_format Classic --correct_areas'
# alg_name='mono'
# date=20251211
# ncremap --dbg_lvl=1 --vrb_lvl=4 -a tempest --src_grd=$ocn_grid_file --dst_grd=$atm_grid_file -m map_${ocn_name}_to_${atm_name}_${alg_name}.${date}.nc -T /tscratch/smturbe/e3sm_grids/CA_ne32_x512/mapping_files/tmp -W $map_opts
...
#         --dbg_lvl=1 --vrb_lvl=2 -T /tscratch/smturbe/e3sm_grids/CA_ne32_x512/mapping_files/tmp \
...
# src=$ocn_grid_file
# dst=$atm_grid_file
# map=${mapping_root}/"map_${ocn_grid_name}_to_${atm_grid_name}_${alg_name}.${datestring}.nc"
# run

# src=$atm_grid_file
# dst=$ocn_grid_file
# map=${mapping_root}/"map_${atm_grid_name}_to_${ocn_grid_name}_${alg_name}.${date}.nc"
# extra=--a2o
# run
# extra=""
...
# src=$lnd_grid_file
# dst=$atm_grid_file
# map=${mapping_root}/"map_${lnd_grid_name}_to_${atm_grid_name}_${alg_name}.${date}.nc"
# run

# src=$atm_grid_file
# dst=$lnd_grid_file
# map=${mapping_root}/"map_${atm_grid_name}_to_${lnd_grid_name}_${alg_name}.${date}.nc"
# run
...
# dst=$lnd_grid_file
# map=${mapping_root}/"map_${atm_name}_to_${lnd_name}_${alg_name}.${date}.nc"
# ncremap -a bilinear -s $src -g $dst -m $map -W '--extrap_method  nearestidavg'

# src=$atm_scrip_grid_file
# dst=$ocn_grid_file
# map=${mapping_root}/"map_${atm_name}_to_${ocn_name}_${alg_name}.${date}.nc"
# ncremap -a bilinear -s $src -g $dst -m $map -W '--extrap_method  nearestidavg'
