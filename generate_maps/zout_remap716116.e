...
+ ask_conda='. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/udunits2-deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/proj4-deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/magics-deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/libxml2_deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/libglib_deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/geotiff-deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/geometric_features-deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/gdal-deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/esmpy-deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/esmf-deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/deactivate-r-base.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/cartopy_offline_data-deactivate.sh"
...
+ eval '. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/udunits2-deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/proj4-deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/magics-deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/libxml2_deactivate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/libglib_deactivate.sh"
...
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/activate.d/ucx-activate.sh"
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/activate.d/udunits2-activate.sh"'
. "/ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/udunits2-deactivate.sh"
++ . /ascldap/users/smturbe/.conda/envs/e3sm-unified_1.11/etc/conda/deactivate.d/udunits2-deactivate.sh
#!/usr/bin/env sh
...
+ atm_grid_file=/tscratch/smturbe/e3sm_grids/ne4/ne4pg2_scrip.nc
...
+ echo 'Using atmosphere grid file /tscratch/smturbe/e3sm_grids/ne4/ne4pg2_scrip.nc'
...
+ cdo -v remapcon,/tscratch/smturbe/e3sm_grids/ne4/ne4pg2_scrip.nc /projects/ccsm/inputdata/ocn/mpas-o/oQU480/ocean.QU.480km.151209.nc /tscratch/smturbe/e3sm_grids/ne4/ne4/map_oQU480_to_ne4np4_mono.251211.nc
 OpenMP:  num_procs=224  max_threads=1  num_devices=0
cdi  warning (find_time_vars): Time variable >Time< not found!

cdo    remapcon (Abort): Unsupported generic coordinates (Variable: refZMid)!
